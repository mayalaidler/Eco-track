...
const FootprintIcon = () => (
  ...
  >
    <path
      ...
      d="M4.871 4.23C7.293 2.871 10.038 2.25 12.875 2.25c2.837 0 5.582.62 7.996 1.98M4.871 4.23a13.435 13.435 0 00-1.82 2.628m1.82-2.628c-.144.33-.28.665-.41.999M19.121 4.23c2.31 1.359 4.102 3.253 5.186 5.456M19.121 4.23a13.413 13.413 0 011.82 2.628m-1.82-2.628c.144.33.28.665.41.999M12 9.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 11.25a.75.75 0 010 1.5.75.75 0 010-1.5z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.125 15.375c.135.33.28.66.435.983m-.435-.983a13.436 13.436 0 00-5.223 3.65m5.223-3.65a13.433 13.433 0 015.223 3.65m-5.223-3.65c.144.33.28.665.41.999"
    />
  </svg>
);
...
const RecycleIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.548 0c-.275-.046-.55-.082-.825-.111m-1.102 0l-.053-.002L3.18 5.79m1.591-.012a48.058 48.058 0 013.478-.397m7.5 0a48.058 48.058 0 003.478.397m-7.5 0a48.108 48.108 0 01-3.478.397m12.548 0c.275.046.55.082.825.111m1.102 0l.053.002L20.82 5.79m-1.591.012a48.058 48.058 0 00-3.478-.397"
    />
  </svg>
);
      ...
      >
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-lg">
          ...
          <p className="text-lg text-brand-gray max-w-3xl mx-auto">
            EcoTrack provides simple tools to help you make more sustainable
            choices. Start by calculating your carbon footprint or learning

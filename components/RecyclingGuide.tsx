      ...
      <div className="bg-white p-8 rounded-xl shadow-lg">
        <div className="text-center mb-6">
          ...
          <p className="text-brand-gray mt-2">
            Enter your city and an item to get local recycling rules.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-brand-gray"
            >
              Item to Recycle (e.g., "Plastic Bottles")
            </label>
            <input
              type="text"
              id="item"
        ...
        {result && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h3 className="text-2xl font-bold mb-4">
              Recycling Guide for{" "}
              <span className="text-brand-green">{item}</span> in{" "}
              <span className="text-brand-green">{location}</span>:
            </h3>
